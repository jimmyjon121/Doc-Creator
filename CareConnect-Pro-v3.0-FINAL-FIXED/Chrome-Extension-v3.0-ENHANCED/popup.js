document.addEventListener('DOMContentLoaded', function() {
    ...
    copyBtn.addEventListener('click', function() {
        ...
        // Try the most likely URL first with extension flag
        const primaryUrl = 'http://localhost:8000/AppsCode-DeluxeCMS.html?fromExtension=true';
        ...
        chrome.tabs.create({ url: primaryUrl }, function(tab) {
            if (chrome.runtime.lastError) {
                ...
                const fileUrl = 'file:///Users/christophermolina/Cursor%20DOCCREATION%20Tool%20/Doc-Creator/Doc-Creator/AppsCode-DeluxeCMS.html?fromExtension=true';
    ...
    function handleTabOpened(tab) {
        ...
        // Wait a bit then try to send data
        setTimeout(() => {
            addActivityLog('Attempting to send data...');
