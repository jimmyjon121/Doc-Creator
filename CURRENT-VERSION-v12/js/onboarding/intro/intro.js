...
class OnboardingIntro {
    ...
    getSubtitleData() {
        return {
            ...
            scene2: [
                ...
                { time: 11.5, duration: 5, text: "The Client Journey widget tracks each stage — from admission through discharge." },
                ...
                { time: 27.5, duration: 3.5, text: "Red zone — what's overdue. Handle these first." },
                { time: 31.5, duration: 3, text: "Yellow — today's priorities." },
                { time: 35, duration: 3, text: "Purple — discharge prep. Green — on track." },
            ...
            scene3: [
                ...
                { time: 3, duration: 4, text: "529 treatment programs — searchable and organized." },
                ...
                { time: 18.5, duration: 4, text: "Semantic filters appear automatically — trauma-focused, ages 13-17." },
                { time: 23, duration: 3.5, text: "Each program card shows what matters." },
                { time: 27, duration: 4, text: "Resilience Recovery — a PHP program in Malibu." },
                ...
                { time: 40, duration: 3.5, text: "Click \"Add to Plan\" — and it's done." },
                { time: 44, duration: 4, text: "The program joins your client's aftercare document." },
                { time: 48.5, duration: 5, text: "Filter by level of care — RTC, PHP, IOP, Wilderness." },
            ...
            scene4: [
                ...
                { time: 11.5, duration: 4.5, text: "Each color represents a level of care — purple for RTC, teal for PHP." },
                { time: 16.5, duration: 3.5, text: "Watch as we zoom into California." },
                { time: 20.5, duration: 3.5, text: "87 programs in this state alone." },
                { time: 24.5, duration: 4.5, text: "The Los Angeles cluster expands — Malibu, Santa Monica, Newport Beach." },
                ...
                { time: 47.5, duration: 3.5, text: "One click — \"Add to Plan.\"" },
            ...
            scene5: [
                ...
                { time: 17, duration: 4.5, text: "Client summary at the top — Emma Thompson, 17, completing residential treatment." },
                ...
                { time: 30.5, duration: 4.5, text: "Choose what to include — program details, contact info, insurance verification." },
                { time: 35.5, duration: 3.5, text: "One click — \"Save to Vault.\"" },
            ...
            scene6: [
                ...
                { time: 18.5, duration: 4.5, text: "Your orbital command center shows every task — color-coded by urgency." },
                { time: 23.5, duration: 4, text: "Red means critical — Emma's review due in two hours." },
                    ...
                    ">
                        ...
                        ">
                            <span style="font-size: ${task.urgency === 'critical' ? 20 : 16}px;">
                                ${task.urgency === 'critical' ? '⚠️' : task.urgency === 'warning' ? '⏰' : task.urgency === 'scheduled' ? '📅' : '✓'}
                            </span>
                        </div>
    ...
    async sceneTranscendence(stage) {
        ...
        const icons = [
            ...
            { emoji: '🗺️', name: 'Programs', angle: 60 },
    ...
    navigateToDashboard() {
        ...
        if (window.showNotification) {
            window.showNotification('Welcome to CareConnect Pro! 🎉', 'success');
        }
    }
