/**
 * @fileoverview Discharge outcome tracking modal
 * @module ui/OutcomeTrackingModal
 * @status @canonical
 * 
 * PURPOSE:
 *   Multi-step modal wizard for capturing discharge outcomes when completing
 *   aftercare plans. Collects structured data about placement success, family
 *   satisfaction, and follow-up requirements. Critical for outcome reporting.
 * 
 * DEPENDENCIES:
 *   - window.clientManager (ClientManager) - Client data updates
 *   - window.aftercareManager (AftercareManager) - Aftercare option updates
 * 
 * EXPORTS TO WINDOW:
 *   - window.outcomeTrackingModal - Singleton instance
 *   - window.OutcomeTrackingModal - Class constructor
 * 
 * OUTCOME TYPES:
 *   - PROGRAM: Client placed in aftercare program
 *   - HOME: Client returning home with outpatient
 *   - OTHER: Alternative placement or AMA
 * 
 * USED BY:
 *   - tracker-aftercare-cascade.js (aftercare completion flow)
 *   - client-profile-manager.js (manual outcome entry)
 */
