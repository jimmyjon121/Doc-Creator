/**
 * @fileoverview Discharged clients archive browser
 * @module ui/DischargedClientsView
 * @status @canonical
 * 
 * PURPOSE:
 *   Provides an archive browser for viewing past/discharged clients with search,
 *   filtering, and pagination. Allows clinical staff to review historical cases
 *   and access outcome data for reporting purposes.
 * 
 * DEPENDENCIES:
 ...
 * 
 * EXPORTS TO WINDOW:
 *   - window.dischargedClientsView - Singleton instance
 *   - window.DischargedClientsView - Class constructor
 *   - window.showActiveClientsView() - Switch to active clients
 *   - window.showDischargedClientsView() - Switch to discharged clients
 *   - window.updateClientCounts() - Refresh tab counts
 * 
 * FEATURES:
 *   - Full-text search by initials/ID
 *   - Filter by house, discharge date range
 *   - Pagination (20 per page)
 *   - Click to open archived profile
 * 
 * USED BY:
 *   - CareConnect-Pro.html (Clients tab discharged toggle)
 *   - cm-tracker.js (discharged tab navigation)
 */
